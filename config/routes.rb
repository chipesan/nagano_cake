...
delete "public/cart_items/:id" => "public_cart_items#destroy", as: "public_cart_items_destroy"
delete "public/cart_items/destroy_all" => "public_cart_items#destroy_all", as: "public_cart_items_destroy_all"

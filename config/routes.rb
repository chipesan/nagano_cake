...
delete "public/cart_items/destroy_all" => "public/cart_items#destroy_all", as: "public_cart_items_destroy_all"
delete "public/cart_items/:id" => "public/cart_items#destroy", as: "public_cart_items_destroy"
